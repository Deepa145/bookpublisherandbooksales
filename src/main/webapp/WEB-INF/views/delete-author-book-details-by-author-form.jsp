...
<title>Delete Author Book Details By Id Form</title>
<style>
.text-danger {
	color: #e80c4d;
	font-size: 0.9em;
...
<button onclick="document.location='/webapp'">Back</button>
    ...
    <h3 style="color: #c51515">Delete Author Book Details By Id</h3>
   <br>
    <form class="form" action="/authorbookdetails/deleteauthorbookdetails" method="get"
        style="margin: 0;">
        <div>
        ...
        <label>Enter Author Id</label> <input type="text" placeholder="Author Id"
            name="authorid"> <input type='submit' value="Delete" name="submit">
            </div>
    </form>
    </div>
    </div>
