...
<button onclick="document.location='/webapp'">Back</button>
	...
	<div id="root">
		<div id="form">
			<form:form class="form" action="add" method="post" modelAttribute="addbooks">
				<div>
				...
				<div>
					<label for="price">Price</label>
						<form:input path="price" placeholder="Price" pattern="^\d{0,8}(\.\d{1,4})?$"
...
required="true" />
				...
				<form:errors path="stockInHand" cssClass="text-danger" pattern="[1-9]{1}[0-9]{9}"
title="Must have Price"
required="true" />
				<div>
