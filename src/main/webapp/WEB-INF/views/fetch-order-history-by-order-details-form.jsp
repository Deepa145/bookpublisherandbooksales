...
<button onclick="document.location='/webapp'">Back</button>
    ...
    <h3 style="color: #c51515">View Order History By Order Details</h3>
    <br>
    <form class="form" action="/orderdhistory/getorderhistorybyorderdetails" method="get"
        style="margin: 0;">
        <div>
        <label>Enter Order Id </label> <input type="text" placeholder="Order Id"
            name="orderid"> <input type='submit' value="Get" name="submit">
            </div>
    </form>
</div>
</div>
